...
url = "http://prod-vault.devops-ontap.com:8200/v1/concourse/cisco-fso-labs/" + name + "/" + "subnetid_public"
...
url = "http://prod-vault.devops-ontap.com:8200/v1/concourse/cisco-fso-labs/" + name + "/" + "cisco-fso-labs_sg_id"
print(url)
