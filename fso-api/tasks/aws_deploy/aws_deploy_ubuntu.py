...
url = "http://prod-vault.devops-ontap.com:8200/v1/concourse/cisco-fso-labs/" + name + "/" + "ubuntu_instance_id"
print(url)
...
url = "http://prod-vault.devops-ontap.com:8200/v1/concourse/cisco-fso-labs/" + name + "/" + "ubuntu_ip"
print(url)
