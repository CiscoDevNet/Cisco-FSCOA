...
fly --target=cisco-fso-lab login --concourse-url=http://prod-ci.devops-ontap.com:8080 -n us-west-1a
...
fly -t ci set-pipeline -c pipeline-cisco-fso-labs -p cisco-fso-labs -l [path to your params file] -v aws.region=us-west-2 -v az.name=us-west-1a -v vault.addr=http://prod-vault.devops-ontap.com:8200
