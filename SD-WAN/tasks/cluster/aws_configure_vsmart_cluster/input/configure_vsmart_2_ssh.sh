...
#vsmart_2
export vsmart_2_index_0_pub_ip=$(vault kv get --field=vsmart_2_index_0_pub_ip concourse/sdwan/$NAME/vsmart_2_index_0_pub_ip)
python3 configure_vsmart_2_ssh.py
