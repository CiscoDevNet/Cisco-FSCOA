...
#vmanage_1
export vmanage_1_index_0_pub_ip=$(vault kv get --field=vmanage_1_index_0_pub_ip concourse/sdwan/$NAME/vmanage_1_index_0_pub_ip)
echo $vmanage_1_index_0_pub_ip
python3 configure_vmanage_1_ssh.py
