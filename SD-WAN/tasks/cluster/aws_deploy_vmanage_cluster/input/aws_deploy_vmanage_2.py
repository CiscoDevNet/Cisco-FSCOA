#!/usr/bin/env python
#This Script creates the vmanage_2 from AMI and the key - split out the key
...
outfile_deploy_vmanage_2='deploy-vmanage_2.json'
outfile_get_vpcid='outfile_get_vpcid.json'

inst_name="vmanage_2"
sg_name=name
priv_sg = os.getenv('priv_sg')
vmanage_2_index_0_AllocationId = os.getenv('vmanage_2_index_0_AllocationId')
vmanage_2_index_1_AllocationId = os.getenv('vmanage_2_index_1_AllocationId')
vmanage_2_index_2_AllocationId = os.getenv('vmanage_2_index_2_AllocationId')
...
with open(outfile_deploy_vmanage_2, 'w') as my_file:
   my_file.write(output)

with open (outfile_deploy_vmanage_2) as access_json:
   read_content = json.load(access_json)
   question_access_vmanage_2 = read_content['Instances']
   replies_access_vmanage_2 = question_access_vmanage_2[0]
   replies_data_vmanage_2=replies_access_vmanage_2['InstanceId']
   print(replies_data_vmanage_2)
   vmanage_2_instance_id=replies_data_vmanage_2 #add this to the vars file
   print(vmanage_2_instance_id)
   vmanage_2_instance_id_var=('vmanage_2_instance_id=' + "'" + "{}".format(vmanage_2_instance_id) + "'")
   vmanage_2_int_ip_addr=replies_access_vmanage_2['PrivateIpAddress']
   print(vmanage_2_int_ip_addr)

with open(outfile_vars, 'a+') as my_file:
   my_file.write(vmanage_2_instance_id_var + "\n")

vmanage_2_instance_id_var=('vmanage_2_instance_id=' + "'" + "{}".format(vmanage_2_instance_id) + "'")
print(vmanage_2_instance_id_var)
with open(outfile_vars, 'a') as my_file:
   my_file.write(vmanage_2_instance_id_var + "\n")

vmanage_2_tag_inst='aws ec2 create-tags --region' + " " + "{}".format(region) + " " + '--resources' + " " +  "{}".format(vmanage_2_instance_id) + " " + '--tags' + " " + "'" + 'Key="Name",Value=vmanage_2-1.0' + "'"
output = check_output("{}".format(vmanage_2_tag_inst), shell=True).decode().strip()
print("Output: \n{}\n".format(output))

cmd_vmanage_2_pub_eni_id='aws ec2 describe-instances --instance-id' + " " + vmanage_2_instance_id + " " + '--query' + " " + 'Reservations[].Instances[].NetworkInterfaces[*].NetworkInterfaceId'
print(cmd_vmanage_2_pub_eni_id)
output = check_output("{}".format(cmd_vmanage_2_pub_eni_id), shell=True).decode().strip()
print("Output: \n{}\n".format(output))
...
cmd_check_instance='aws ec2 wait instance-running --instance-ids' + " " + vmanage_2_instance_id + " " + '--region' + " " + "{}".format(region)
output = check_output("{}".format(cmd_check_instance), shell=True).decode().strip()
print("Output: \n{}\n".format(output))

cmd_associate_eip_pub='aws ec2 associate-address --allocation-id' + " " + "{}".format(vmanage_2_index_0_AllocationId) + " " + '--network-interface-id' + " " + pub_eni_id
...
cmd_add_vmanage_2_nic='aws ec2 create-network-interface --region' + " " "{}".format(region) + " " + '--subnet-id' + " " + "{}".format(subnetid_mgmt) + " " + '--description "vmanage_2_nic_mgmt_sub"' + " " + '--groups' + " " + "{}".format(sgid) + " " + "{}".format(priv_sg) + " " + '--tag-specifications' + " " + "'ResourceType=network-interface,Tags=[{Key=Name,Value=" + "{}".format(name) + "index_1" + '}]'"" + "'"
...
cmd_attach_vmanage_2_nic='aws ec2 attach-network-interface --region' + " " + "{}".format(region) + " " + '--network-interface-id' + " " + "{}".format(mgmt_eni_id) + " " + '--instance-id' + " " + "{}".format(vmanage_2_instance_id) + " " + '--device-index 1'
...
cmd_associate_eip_mgmt='aws ec2 associate-address --allocation-id' + " " + vmanage_2_index_1_AllocationId + " " + '--network-interface-id' + " " + mgmt_eni_id
...
outfile_attach_vmanage_2_nic='attach-vmanage_2-nic.json'
cmd_attach_vmanage_2_nic='aws ec2 attach-network-interface --region' + " " + "{}".format(region) + " " + '--network-interface-id' + " " + "{}".format(cluster_eni_id) + " " + '--instance-id' + " " + "{}".format(vmanage_2_instance_id) + " " + '--device-index 2'
output = check_output("{}".format(cmd_attach_vmanage_2_nic), shell=True).decode().strip()
print("Output: \n{}\n".format(output))
with open(outfile_attach_vmanage_2_nic, 'w') as my_file:
    my_file.write(output)

cmd_associate_eip_cluster='aws ec2 associate-address --allocation-id' + " " + vmanage_2_index_2_AllocationId + " " + '--network-interface-id' + " " + cluster_eni_id
...
cmd_create_volume='aws ec2 create-volume --volume-type gp3 --size 100 --availability-zone' + " " + az + " " + '--tag-specifications' + " " + 'ResourceType=volume,Tags=[{Key=Description,Value=vmanage_2-vol}]'
...
cmd_attach_vol='aws ec2 attach-volume --volume-id' + " " + vol_id + " " + '--instance-id' + " " + vmanage_2_instance_id + " " + '--device /dev/sdf'
...
cmd_check_instance='aws ec2 wait instance-status-ok --instance-ids' + " " + vmanage_2_instance_id + " " + '--region' + " " + "{}".format(region)
output = check_output("{}".format(cmd_check_instance), shell=True).decode().strip()
print("Output: \n{}\n".format(output))
...
url = "http://prod-vault.devops-ontap.com:8200/v1/concourse/sdwan/" + name + "/" + "vmanage_2" + "/" + "vmanage_2_instance_id"
print(url)
...
#data = f'{{"token": "{TOKEN}"}}'
data_json = {"vmanage_2_instance_id": vmanage_2_instance_id }
...
url = "http://prod-vault.devops-ontap.com:8200/v1/concourse/sdwan/" + name + "/" + "vmanage_2" + "/" + "pub_eni_id"
print(url)
...
url = "http://prod-vault.devops-ontap.com:8200/v1/concourse/sdwan/" + name + "/" + "vmanage_2" + "/" + "mgmt_eni_id"
print(url)
