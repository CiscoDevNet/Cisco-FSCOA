...
#12 - ASSOCIATE THE mgmt ROUTE TABLE WITH THE DEFAULT VPC ROUTE TABLE
...
print("ASSOCIATE The public ROUTE TABLE WITH THE DEFAULT VPC ROUTE TABLE")
...
#Create a Security Group for Public - and set it to allow All traffic from the SG created above plus all those required for sdwan
